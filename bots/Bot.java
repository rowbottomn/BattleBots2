...
public abstract class Bot {
     ...
     */
    public static final int RADIUS = (int)(BattleBotArena.RIGHT_EDGE/120);//changed from 13//changed from 10
    ...
    /**
     * A simple debug method that prints a message to the console if the DEBUG
     * constant in BattleBotArena is set to true.
     * If all students are using this method, it will be easy to turn off all debug messages for the final tournament.
     *
